...
class ModuleManager extends \Nette\Object
{
    ...
    {
        $presenter_name = "FrontModule\\{$module}Presenter";
    ...
    public function buildLinkableModulesCache()
    {
        ...
        $presenters = $presenters->getPresenters('Front');

        $links = array();
        foreach ($presenters as $presenter) {
            if ($presenter->getPresenterReflection()->hasAnnotation('module'))
                $links[$presenter->name] = $presenter->getPresenterReflection()->getAnnotation('module')->name;
        }
    ...
    public function buildModulesInfoCache()
    {
        ...
        foreach ($modules as $module) {
            $moduleFront = 'FrontModule\\' . $module . 'Presenter';
